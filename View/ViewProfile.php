                ...
                <div class="col">
                    <div class="portlet light profile-sidebar-portlet bordered">
                        ...
                        <div class="profile-userbuttons">
                            ...
                            <!--Adding wink to database by wink.php-->
                            <a href="../Controller/wink.php?personID=<?php echo $viewPersonID; ?>"
                               class="btn btn-info  btn-sm">Wink</a>
                            <!--Adding favourite to database by addToFavorite.php-->
                            <a href="../Controller/addToFavorite.php?personId=<?php echo $viewPersonID; ?>"
                               class="btn btn-info btn-sm">Add Favorite </a>
                        </div>
                    </div>
                </div>
                <div class="col">
